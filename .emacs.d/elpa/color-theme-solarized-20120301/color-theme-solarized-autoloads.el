...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "solarized-definitions" '("create-solarized-theme" "solarized-")))

;;;***

;;;### (autoloads nil nil ("color-theme-solarized-pkg.el" "solarized-dark-theme.el"
;;;;;;  "solarized-light-theme.el") (0 0 0 0))
